...
export const metadata: Metadata = {
  title: "ポートフォリオ | 飯塚健杜",
  description: "フルスタックエンジニア 飯塚健杜のポートフォリオ。React / Next.js / AWS を活用した開発実績。",
};
...
const projectGrid: Project[] = [
  { title: "イベント管理基盤", tags: ["Serverless", "AWS"], oneLiner: "インフラコスト98.5%削減を実現したサーバーレスイベント基盤", stack: "Nuxt, Lambda, DynamoDB", role: "アーキ設計", category: "Featured", link: "/portfolio/projects/wecall", cta: "詳しく" },
  { title: "チケット発券システム", tags: ["High Load", "LINE"], oneLiner: "1000+req/secの高負荷に対応するチケット発券システム", stack: "Vue, Next.js, BullMQ", role: "リードエンジニア", category: "Featured", link: "/portfolio/projects/weno", cta: "詳しく" },
  { title: "試着予約システム", tags: ["EventTech", "LINE"], oneLiner: "7000人規模のイベントに対応するLINE連携試着予約システム", stack: "NestJS, Vue, AWS, DDD", role: "PM / Full-Stack", link: "/portfolio/projects/wefit", cta: "聞いてみる" },
  { title: "在庫・注文管理システム", tags: ["Inventory", "Real-time"], oneLiner: "Socket.ioによるリアルタイム在庫・注文管理システム", stack: "Vue, NestJS, Socket.io", role: "フルスタック", link: "/portfolio/projects/wecart", cta: "聞いてみる" },
  { title: "SNAP", tags: ["SaaS", "B2B"], oneLiner: "結婚式場向けサブスクリプション型フォトブースSaaS", stack: "React, AWS", role: "オーナー/エンジニア", link: "/portfolio/projects/snap", cta: "概要" },
  { title: "Ongy", tags: ["Scraping", "Analytics"], oneLiner: "代理店向けInstagramストーリー競合調査プラットフォーム", stack: "React, Puppeteer", role: "単独開発", link: "/portfolio/projects/ongy" },
  { title: "Inuinugram", tags: ["Growth", "Automation"], oneLiner: "自動化とグロースハックにより3万フォロワーを獲得し売却に成功した犬特化型メディア", stack: "Python, Puppeteer", role: "Growth Engineer", link: "/portfolio/projects/inuinugram" },
  { title: "Lulu", tags: ["LINE", "Serverless"], oneLiner: "Google Apps Scriptを活用したコストゼロのLINE家計簿アプリケーション", stack: "GAS, LIFF", role: "単独開発", link: "/portfolio/projects/lulu" },
  { title: "iPLUSi", tags: ["Web", "WordPress"], oneLiner: "モダンなWordPress構成による建築事務所ポートフォリオサイト", stack: "WordPress (Sage), PHP", role: "Full-Stack", link: "/portfolio/projects/iplusi" },
  { title: "INTD", tags: ["Corporate", "CMS"], oneLiner: "カスタムWordPressテーマによるコーポレートサイトリニューアル", stack: "WordPress, PHP, Figma", role: "Lead", link: "/portfolio/projects/intd" },
  { title: "meiso.", tags: ["Design", "Branding"], oneLiner: "ブランドアイデンティティを体現するマインドフルネス企業コーポレートサイト", stack: "HTML, CSS, JS", role: "デザイナー/開発", link: "/portfolio/projects/meiso" },
  { title: "Lounge Attendance", tags: ["B2B", "GAS"], oneLiner: "QRコードとGoogle Apps Scriptによるコスト効率的な来訪管理システム", stack: "GAS, Sheets, QR", role: "Single Dev", link: "/portfolio/projects/lounge-attendance" },
  { title: "Life in Weeks", tags: ["Personal", "Visualization"], oneLiner: "人生を週単位グリッドでビジュアライズする時間管理ツール", stack: "Vue, Nuxt", role: "Solo Dev", link: "/portfolio/projects/life-in-weeks" },
  { title: "Sheer", tags: ["Media", "Management"], oneLiner: "若年層女性をターゲットとしたInstagramメディアの運営管理", stack: "Instagram, Figma", role: "Team Manager", link: "/portfolio/projects/sheer" },
  { title: "Miss Circle", tags: ["Scraping", "Automation"], oneLiner: "コンテスト参加者向けSNSエンゲージメント分析ツール", stack: "Vue, Node, Puppeteer", role: "Full-Stack", link: "/portfolio/projects/miss-circle" },
  { title: "FACT", tags: ["Sales", "Reputation"], oneLiner: "企業向けレピュテーション管理・分析SaaSプラットフォーム", stack: "Sales, Marketing", role: "Sales & Marketing Lead", link: "/portfolio/projects/fact" },
  { title: "Book Price", tags: ["Tooling", "Resale"], oneLiner: "メルカリ市場データを活用した書籍価格分析ツール", stack: "Vue, GAS, API", role: "Solo Dev", link: "/portfolio/projects/book-price" },
  { title: "Monoton", tags: ["BizDev", "Retail"], oneLiner: "セルフ写真スタジオ事業の創業から運営までを担当", stack: "Business Dev, Ops", role: "Founder", link: "/portfolio/projects/monoton" },
  { title: "ACE", tags: ["PoC", "Affiliate"], oneLiner: "複数ASPを統合したアフィリエイト成果管理プラットフォーム", stack: "RPA, JS, BizDev", role: "Product Owner", link: "/portfolio/projects/ace" },
  { title: "WAISEC", tags: ["Event", "Leadership"], oneLiner: "国際高校生シンポジウムのWebサイト制作および運営統括", stack: "HTML/CSS, Management", role: "Committee Lead", link: "/portfolio/projects/waisec" },
  { title: "Hana", tags: ["Presentation", "Global"], oneLiner: "国際シンポジウムにおける英語プレゼンテーションとビジュアルデザイン", stack: "Presentation, Design", role: "Presenter", link: "/portfolio/projects/hana" },
];
...
function FeaturedProjectCard({ project }: { project: Project }) {
  const href = project.link ?? `/portfolio/projects/${project.title.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "")}`;
    ...
    <div className="relative isolate min-h-screen w-full overflow-hidden bg-white">
      <header className="sticky top-0 z-20 border-b border-slate-100 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
          ...
          <a href="#contact" className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-700">
            相談する
          </a>
        </div>
      </header>
      ...
      <main className="relative z-10 mx-auto flex max-w-6xl flex-col gap-32 px-4 pb-24 pt-16 sm:px-6 sm:pt-24">
        ...
        <section id="projects" className="flex flex-col gap-10">
          ...
          <div className="mt-6 flex items-center justify-between">
            <SectionHeader title="その他のプロジェクト" />
          </div>
